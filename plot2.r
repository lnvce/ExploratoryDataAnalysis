plot2 <- function(my_working_dir="C:/Users/ealonvic/Documents/Rhmwk/exdata%2Fdata%2Fhousehold_power_consumption", DEBUGR=FALSE)
{
# Programiing assignment #2
# Requirements:
#
# 1) The library, dplyr, is required and used to filter and clean up data. 
...
with (sample_df, plot(Timestamp, Global_active_power, ylab="Global Active Power (kilowatts)",xlab="", type="l") )
dev.off()
#
if (DEBUGR == TRUE) {
